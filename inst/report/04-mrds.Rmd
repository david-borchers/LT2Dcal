...
Methods To see the affect of imperfect matching, we simulated `r Nanimals` animals and had them move in the same way as before. We used the same detection function but did not multiply by 0.8 (i.e. kept p(0) = 1).
